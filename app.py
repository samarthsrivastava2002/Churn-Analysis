...
@app.route("/")
def loadPage():
	return render_template('home.htm', query="")
...
def predict():
    ...
    model = pickle.load(open("C:/Users/lipis/Python Projects/model.sav", "rb"))
    ...
    return render_template('home.htm', output1=o1, output2=o2, 
